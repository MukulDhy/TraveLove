...
const SpecialOffer = () => {
  ...
  const handlePause = () => {
    ...
    // You can add custom logic here, such as updating the state, showing a message, etc.
    // For example, we could update the state to track if autoplay is paused.
  ...
  return (
    <div className="mt-12">
      <Swiper
        spaceBetween={30}
        slidesPerView={5}
        onPause={handlePause} // Custom onPause handler
        autoplay={{
          delay: 2000,
