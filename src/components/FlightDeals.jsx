        ...
        <div className="w-full h-full flex flex-col dealsShadow rounded-b gap-2 ">
          <div className="w-full h-full">
            <img
              src={sunrise}
              alt=""
              className="w-full h-full object-cover rounded-t hidden md:block"
            />
            <img
              src={msunrise}
              alt=""
              className="w-full h-full object-cover rounded-t block md:hidden"
            />
          </div>
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4 py-3">
            <div className="flex flex-row items-center justify-between w-full">
              <h1 className="text-[#6E7491] text-base font-medium capitalize">
                ...
                <span className="text-[#605DEC]">Kenya</span>
              </h1>
              <p className="text-[#6E7491] text-base font-medium"></p>
            </div>
