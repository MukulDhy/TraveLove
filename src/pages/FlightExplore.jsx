...
const FlightExplore = () => {
  const { flightType, departureDate, returnDate } = useSelector(
    (state) => state.searchFilter
  );
  const departureDetail = useSelector(
    (state) => state.searchFilter.fromCityInfo
  );
  const destinationDetail = useSelector(
    (state) => state.searchFilter.toCityInfo
  );
  // console.log(departureDetail)
  // console.log(flightType,departureDate,returnDate)
