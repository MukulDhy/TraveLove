...
import SearchFilter from "../Function/SearchFilter/SearchFilter.jsx";
...
const Hero = () => {
  ...
  return (
    <>
      <div
        className="h-96 sm:h-[500px] w-full overflow-hidden relative z-1"
        style={{
      ...
      >
        <img
          ...
          src={plain}
          alt=""
          className="mx-auto pt-20  opacity-60"
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 w-full h-full bg-black/20 z-10">
          <div className="max-w-7xl mx-auto px-5 sm:px-10">
            <div className="absolute top-1/2 -translate-y-2/4 text-white">
              ...
              <p className="mt-3 sm:mt-6 sm:text-lg">
                You Can Get{" "}
                <span className="font-semibold">50% Discount Price</span> for
                Flight Ticket on Call only.{" "}
              </p>
