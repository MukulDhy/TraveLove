...
const TrackingNavigation = () => {
  ...
  function calculateArrivalDate(departureDate, departureTime, arrivalTime) {
    ...
    const arrivalDate = departureDateTime;
      ...
      {getAllData && (
        <section>
          <div className=" mb-8 flex lg:justify-between lg:items-center lg:flex-row flex-col ">
            <h1 className="mt-5 font-bold text-lg md:text-3xl text-cyan-600 dark:text-gray-400">
              Review Your Booking
            </h1>
          ...
          {/* Traking Card */}
          <div className="shadow-xl pt-2 block rounded-xl overflow-hidden dark:bg-white/10 dark:backdrop-blur-xl  dark:shadow-sm dark:shadow-gray-500">
            <div className="px-5">
